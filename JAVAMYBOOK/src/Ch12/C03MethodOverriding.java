...
public class C03MethodOverriding {
	...
	public static void main(String[] args) {
		...
		System.out.println("-----------------");
		ani = dog1;// 상위클래스 참조변수로 하위객체 Dog연결
		ani.sound();
		ani = cat1;// 상위클래스 참조변수로 하위객체 Cat연결
		ani.sound();
